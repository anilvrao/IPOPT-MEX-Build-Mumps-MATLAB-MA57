...
bool MinC_1NrmRestorationPhase::PerformRestoration()
{
   ...
   if( max_wall_time_ < 1e20 )
   {
      ...
      if( elapsed >= max_wall_time_ )
      {
         Jnlst().Printf(J_WARNING, J_LINE_SEARCH,
                        "Maximal wallclock time exceeded at start of restoration phase.\n");
         return false;
      }
   ...
   if( max_cpu_time_ < 1e20 )
   {
      ...
      {
         Jnlst().Printf(J_WARNING, J_LINE_SEARCH,
                        "Maximal CPU time exceeded at start of restoration phase.\n");
         return false;
      }
   ...
   {
      Jnlst().Printf(J_WARNING, J_LINE_SEARCH,
                     "Maximal wallclock time exceeded in restoration phase.\n");
      retval = 1;
   }
   ...
   {
      Jnlst().Printf(J_WARNING, J_LINE_SEARCH,
                     "User requested stop during restoration phase.\n");
      retval = 1;
   }
